...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "your brother") >= 0)
		{
		...
		else if (findKeyword(statement, "date") >= 0 || findKeyword(statement, "time") >= 0)
		{
			response = date.toString();
		}
		else if (findKeyword(statement, "Valentine's Day") >= 0)
		{
			response = "February 14th";
		}
		else if (findKeyword(statement, "AP CSA Room Number") >= 0)
		{
			response = "F101";
		}
